...
\caption{\label{tab:tab9}Summary of the fit of model 9. The model fit corresponds to the fit of a model with the following formula: {\small$\mathtt{twin \sim 1 + poly(cbind(age, parity), 3) + (1 | pop) + (1 | maternal\_id)}$}. See legend of Table S1 for more details.}
\centering
...
random effects & variance between $\mathtt{pop}$ & 0.0571 &  & \\
 & variance between $\mathtt{maternal\_id}$ & 0.485 &  & \\
