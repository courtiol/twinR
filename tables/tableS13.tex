...
\caption{\label{tab:tab13}Summary of the fit of model 13. The model fit corresponds to the fit of a model with the following formula: {\small$\mathtt{twin \sim 1 + (1 | pop)}$}. See legend of Table S1 for more details.}
\centering
...
random effects & variance between $\mathtt{pop}$ & 0.0594 &  & \\
