...
\caption{\label{tab:tab12}Summary of the fit of model 12. The model fit corresponds to the fit of a model with the following formula: {\small$\mathtt{twin \sim 1 + (1 | pop) + (1 | maternal\_id)}$}. See legend of Table S1 for more details.}
\centering
